...
* **CRITICAL**: StatusBar polling regression fix - reduced subprocess spawning from 360/hour to 12/hour (99% improvement) ([main](https://github.com/Draculabo/AntigravityManager/tree/main))
* Process handler optimization with 60s caching and 5s rate limiting ([main](https://github.com/Draculabo/AntigravityManager/tree/main))
* Proxy controller tests updated to use correct API methods ([main](https://github.com/Draculabo/AntigravityManager/tree/main))

### ✨ Features

* Model Visibility Settings - complete UI for hiding/showing individual models with search and persistence ([main](https://github.com/Draculabo/AntigravityManager/tree/main))

### 📋 Future Features (Ready for Implementation)

* **Provider Groupings & Collapsible UI** - Intelligent model grouping by provider (Claude/Gemini/Others) with collapsible interface and account-level calculators ([PROVIDER_GROUPINGS_CHANGE_REQUEST.md](PROVIDER_GROUPINGS_CHANGE_REQUEST.md))
